<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo get_template_directory_uri(); ?>/build/img/apple-touch-icon.png">
  <link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>/build/img/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/build/img/favicon-16x16.png">
  ...
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/build/styles/vendor/tippy.css">
  ...
  <noscript><div><img src="https://mc.yandex.ru/watch/91743796" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
  <!-- /Yandex.Metrika counter -->
  <?php wp_head(); ?>
</head>