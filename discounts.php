  ...
  <div class="wrapper">
    ...
    <div class="discounts__inner">
      ...
      <a href="<?php echo get_template_directory_uri(); ?>/sign/" class="discounts__item">
        ...
        <div class="discounts__subtitle">В честь открытия нашей студии дарим скидку 15% на все процедуры!<br>Спешите записаться, наши мастера с нетерпением ждут вас в гости. ей студии дарим скидку 15% на всe. ей студии дарим скидку 15% на всe.</div>
        <span class="discounts__period">Акция продлится до 01.12.2022г.</span>
      </a>
      <a href="<?php echo get_template_directory_uri(); ?>/sign/" class="discounts__item">
        <img src="<?php echo get_template_directory_uri(); ?>/build/img/GIF.gif" alt="" class="discounts__img"> 
